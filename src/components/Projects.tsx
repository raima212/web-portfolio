  ...
  return (
    <section ref={ref} id="projects" className="py-24 bg-gray-800 relative">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        {/* Projects Grid */}
        <div className={`flex flex-wrap justify-center gap-8 mb-16 transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <Suspense fallback={
            <>
              <div className="w-full sm:w-80 lg:w-96"><ProjectSkeleton /></div>
              <div className="w-full sm:w-80 lg:w-96"><ProjectSkeleton /></div>
              <div className="w-full sm:w-80 lg:w-96"><ProjectSkeleton /></div>
            </>
          }>
            ...
            <div
              key={project.id}
              className="bg-gray-900 border border-gray-800 rounded overflow-hidden hover:border-gray-600 transition-all duration-300 cursor-pointer w-full sm:w-80 lg:w-96"
