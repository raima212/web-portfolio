  ...
  const projects: Project[] = [
    {
      id: 1,
      title: 'West LA',
      description: 'Fivem police squad management system',
      longDescription: 'A comprehensive roleplay game management system built with Next.js, TypeScript, and Tailwind CSS. Integrated with Supabase for backend functionality and Amazon S3 Bucket for image storage. Built with modern development practices including component-based architecture, RESTful API integration, and real-time data synchronization.',
      ...
      features: [
        'User registration and application system for new roleplay team members.',
        'Player complaint and reporting system.',
        'Personnel directory and information pages.',
        'User authentication with personalized dashboards for players to view and edittheir information.',
        'Internal communication system for sharing photos, PDFs, and emails.',
        'Administrative panel for team managers to add/edit members, customize site themes, manage application forms.',
        'Disciplinary action system for administrators to open investigations and issue penalties.',
        'Built with modern development practices including component-based architecture.',
    ...
    },
    {
      ...
      description: 'Advanced task management application for team collaboration',
      longDescription: 'Project management application supporting agile methodologies with kanban board and gantt chart features. Real-time collaboration and detailed reporting capabilities.',
      image: '/api/placeholder/400/300',
