  ...
  const projects: Project[] = [
    {
      ...
      longDescription: 'Roleplay game management system built with Next.js, TypeScript, and Tailwind CSS. Uses Supabase for backend and Amazon S3 for image storage. Has user authentication, real-time updates, and admin dashboard.',
